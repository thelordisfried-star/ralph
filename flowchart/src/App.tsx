    ...
    (newCount: number) => {
      ...
      setEdges((eds) =>
        eds.map((edge) => {
          ...
          // ⚡ Bolt Optimization: Use functional setters to selectively modify style properties, avoiding O(N) recreations and preserving referential stability.
          return {
            ...edge,
