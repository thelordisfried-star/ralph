...
// ⚡ Bolt Optimization: Wrap CustomNode in React.memo to prevent unnecessary global re-renders on React Flow internal state updates (pan/zoom)
...
// ⚡ Bolt Optimization: Wrap NoteNode in React.memo to prevent unnecessary global re-renders on React Flow internal state updates (pan/zoom)
...
// ⚡ Bolt Optimization: Extract React Flow constants to module scope to prevent referential instability and re-renders
...
function App() {
  ...
  // ⚡ Bolt Optimization: Use module-level `positions` instead of reading the ref's current value during useMemo init to avoid ESLint refs during render errors
  ...
  const handleReset = useCallback(() => {
    ...
    // ⚡ Bolt Optimization: Reuse already memoized initialNodes/Edges rather than creating O(N) duplicate arrays and objects
