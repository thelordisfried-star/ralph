...
// ⚡ Bolt Optimization: Wrap React Flow custom nodes in React.memo
// Prevents unnecessary re-renders when other parts of the flow state change
// Expected Impact: Reduces wasted render cycles on nodes whose props (data, selected, etc.) haven't changed.
...
// ⚡ Bolt Optimization: Wrap React Flow note nodes in React.memo
