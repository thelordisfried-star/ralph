...
// Pre-compute stable data objects and style constants to prevent ReactFlow nodes
// from re-rendering due to new object references being passed to data/style props.
