...
// ⚡ Bolt Optimization: Wrapped CustomNode in React.memo()
// Impact: Prevents unnecessary global re-renders of nodes when the internal React Flow graph state updates (e.g., during panning or zooming).
...
// ⚡ Bolt Optimization: Wrapped NoteNode in React.memo()
// Impact: Prevents unnecessary global re-renders of nodes when the internal React Flow graph state updates (e.g., during panning or zooming).
