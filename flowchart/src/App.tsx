...
function createEdge(conn: typeof edgeConnections[0], visible: boolean): Edge {
  return {
    ...
    data: { originalLabel: conn.label as string | undefined },
    animated: visible,
    style: {
      stroke: '#222',
      strokeWidth: 2,
...
function App() {
  ...
  // ⚡ Bolt Optimization: Use functional setters to selectively update node/edge visibility styles
  // instead of recreating all nodes/edges from scratch (O(N) object allocations) on every step.
