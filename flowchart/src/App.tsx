...
function App() {
  ...
  // ⚡ Bolt Optimization: Use functional state updates to only modify node/edge styles rather than recreating them entirely (O(N) object allocations -> O(1) mutations for stable elements).
