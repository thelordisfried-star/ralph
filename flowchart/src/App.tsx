...
function App() {
  ...
  // ⚡ Bolt Optimization: Functional setters correctly map over source/target properties without fragile string parsing
    ...
    setNodes((nds) =>
      nds.map((node) => {
        ...
        if (node.type === 'custom') {
          ...
          isVisible = noteData ? newCount >= noteData.appearsWithStep : false;
        }
