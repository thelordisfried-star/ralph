...
function App() {
  ...
  // ⚡ Bolt Optimization: Calculate initial elements inline instead of relying on external helpers that trigger recreation
  ...
  // ⚡ Bolt Optimization: Update visibility styles using functional setters instead of recreating element arrays
