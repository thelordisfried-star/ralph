...
// Pre-calculate stable data objects to prevent unnecessary re-renders
const stepDataMap = new Map();
allSteps.forEach(step => {
  stepDataMap.set(step.id, {
    title: step.label,
...
notes.forEach(note => {
  noteDataMap.set(note.id, { content: note.content, color: note.color });
});
