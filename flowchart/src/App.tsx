...
function App() {
  ...
  // ⚡ Bolt Optimization: Use functional state updates to toggle node and edge visibility
  // instead of re-creating the entire node/edge arrays from scratch. This avoids O(N) object
  // allocations, prevents React Flow from destroying internal node state/dimensions, and
  // eliminates the need to manually track coordinates in refs to restore position after dragging.
