...
// ⚡ Bolt Optimization: Wrap ReactFlow CustomNode in React.memo()
// This prevents expensive re-renders on nodes when panning and zooming, significantly
// improving framerates on complex graphs.
...
// ⚡ Bolt Optimization: Wrap ReactFlow NoteNode in React.memo()
// Prevents unnecessary re-renders of the text note during viewport pan/zoom interactions.
...
function App() {
  ...
  // ⚡ Bolt Optimization: Use module-level `positions` instead of `nodePositions.current` during render setup.
  // This prevents React from throwing "Cannot access refs during render" errors, resolving the ESLint warning,
  // and maintains a referentially stable initial state.
