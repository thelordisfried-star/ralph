...
function App() {
  ...
  // ⚡ Bolt Optimization: Use functional state updates to modify visibility styles, preventing O(N) re-creations and preserving internal node/edge state (e.g. positions) across steps.
