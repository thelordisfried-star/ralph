...
// ⚡ Bolt Optimization: Memoize custom nodes to prevent unnecessary global re-renders
// when the internal React Flow graph state updates (e.g., pan, zoom).
...
// ⚡ Bolt Optimization: Memoize NoteNode to prevent unnecessary re-renders.
...
function App() {
  ...
  // ⚡ Bolt Optimization: Reuse memoized initialNodes and initialEdges during reset
  // instead of recreating objects, preventing redundant O(N) object allocations.
