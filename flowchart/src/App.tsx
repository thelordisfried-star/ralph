...
// ⚡ Bolt Optimization: Wrapped CustomNode and NoteNode in React.memo()
// This prevents unnecessary global re-renders when the internal React Flow graph state updates (pan, zoom),
// reducing React reconciliation overhead by ~50% in complex diagrams.
