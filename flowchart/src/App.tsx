...
// Optimized: Moved getNodes logic outside App to prevent recreation on every render
const getNodesList = (count: number, currentPositions: { [key: string]: { x: number; y: number } }) => {
...
// Optimized: Calculated statically to avoid re-calculation on every render
...
function App() {
  ...
  // Optimized: Use static initial values
  ...
  const handleReset = useCallback(() => {
    ...
    setNodes(getNodesList(1, nodePositions.current));
