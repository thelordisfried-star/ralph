...
// ⚡ Bolt Optimization: Memoizing CustomNode prevents unnecessary global re-renders
// when internal React Flow graph state updates (e.g., pan, zoom).
...
// ⚡ Bolt Optimization: Memoizing NoteNode prevents unnecessary global re-renders
// when internal React Flow graph state updates (e.g., pan, zoom).
...
function App() {
  ...
  // Use the module-level 'positions' constant here to avoid accessing the ref during render
  // which causes strict ESLint "Cannot access refs during render" errors.
