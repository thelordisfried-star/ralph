...
// Bolt: Pre-calculate data objects to ensure referential stability.
// This prevents unnecessary re-renders of nodes when the node list is regenerated.
...
// Bolt: Memoize custom nodes to prevent re-renders when other parts of the graph change.
// Relies on stable 'data' props from stepDataMap/noteDataMap.
...
const NoteNode = memo(function NoteNode({ data }: {
