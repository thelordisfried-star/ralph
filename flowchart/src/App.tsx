...
// ⚡ Bolt Optimization: Wrap CustomNode in React.memo to prevent unnecessary re-renders during internal React Flow graph state updates (e.g. pan, zoom).
...
// ⚡ Bolt Optimization: Wrap NoteNode in React.memo to prevent unnecessary re-renders during internal React Flow graph state updates (e.g. pan, zoom).
...
function App() {
  ...
  // ⚡ Bolt Optimization: Avoid accessing ref during render by using the module-level positions constant for initialNodes.
